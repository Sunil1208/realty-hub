    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postal_code', models.CharField(blank=True, default='795001', max_length=20, verbose_name='Postal Code')),
                ('street_address', models.CharField(blank=True, default='Gandhi Avenue', max_length=255, verbose_name='Street Address')),
                ...
                ('total_floors', models.PositiveIntegerField(default=0, verbose_name='Number of floors')),
                ...
                ('property_type', models.CharField(choices=[('Apartment', 'Apartment'), ('House', 'House'), ('Office', 'Office'), ('Warehouse', 'Warehouse'), ('Commercial', 'Commercial'), ('Other', 'Other')], default='Other', max_length=50, verbose_name='Property Type')),
                ...
                ('published_status', models.BooleanField(default=False, help_text='Is property published?', verbose_name='Published Status')),
