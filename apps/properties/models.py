...
class Property(TimeStampedUUIDModel):
    class AdvertTypeChoices(models.TextChoices):
    ...
    country = CountryField(
        verbose_name=_("Country"), default="IN", blank_label=_("Select country")
    )
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Mumbai")
    postal_code = models.CharField(
        verbose_name=_("Postal Code"), max_length=20, blank=True, default="795001"
    )
    ...
    bathrooms = models.DecimalField(
        verbose_name=_("Bathrooms"), default=1.0, max_digits=4, decimal_places=2
    )
    advert_type = models.CharField(
        verbose_name=_("Advert Type"),
        max_length=50,
        choices=AdvertTypeChoices.choices,
        default=AdvertTypeChoices.FOR_SALE,
    )
    ...
    published_status = models.BooleanField(
        ...
        default=False,
        help_text=_("Is property published?"),
    )
