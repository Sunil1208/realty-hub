# Generated by Django 5.1.6 on 2025-02-21 21:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=15, null=True, region=None, verbose_name='Phone Number')),
                ('about', models.TextField(default='Say something about yourself', verbose_name='About me')),
                ...
                ('gender', models.CharField(choices=[('M', 'Male'), ('F', 'Female'), ('O', 'Other')], default='O', verbose_name='Gender')),
                ...
                ('top_agent', models.BooleanField(default=False, help_text='Are you a top real estate agent?', verbose_name='Top Agent')),
                ('rating', models.DecimalField(blank=True, decimal_places=2, max_digits=4, null=True, verbose_name='Rating')),
                ('num_reviews', models.PositiveIntegerField(blank=True, default=0, null=True, verbose_name='Number of Reviews')),
